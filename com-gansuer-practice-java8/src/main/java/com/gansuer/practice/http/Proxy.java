package com.gansuer.practice.http;
...
//			put("https", "120.195.194.186:80");
    ...
    public static void main(String args[]) {
        ...
        Iterator<String> it = Proxy.proxyMap.keySet().iterator();
        while (it.hasNext()) {
            String key = it.next();
            String value = Proxy.proxyMap.get(key);
        ...
        // proxy property
        System.out.println("\n+++++++++ proxy property +++++++++");
        Iterator<String> it2 = Proxy.proxyMap.keySet().iterator();
        while (it2.hasNext()) {
            String key = it2.next();
            String value = Proxy.proxyMap.get(key);
        ...
        // proxy socks
        System.out.println("\n++++++++ proxy socks +++++++++++");
        Iterator<String> it3 = Proxy.proxyMap.keySet().iterator();
        while (it3.hasNext()) {
            String key = it3.next();
            String value = Proxy.proxyMap.get(key);
